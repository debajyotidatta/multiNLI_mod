...
def argparser(sent):
    ...
    args = parser.parse_args(sent.split())
    return args
...
# args = argparser("cbow petModel-2 --keep_rate 0.9 --alpha 0.15 --emb_train --datapath /home/ubuntu/Dropbox/xai/AdditionalStuff/RepEval2016/data")
