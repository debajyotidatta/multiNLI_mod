...
class modelClassifier:
    def __init__(self, seq_length, loaded_embeddings, loaded_embeddings2):
        ...
        # self.word_embeddings2 = loaded_embeddings2
    ...
    def train(self, train_mnli, train_snli, dev_mat, dev_mismat, dev_snli):       
        ...
        # self.sess.run(self.model.embedding2_init, feed_dict={self.model.embedding_placeholder_bi: self.word_embeddings2})
        ...
        while True:
            ...
            for i in range(total_batch):
                ...
                minibatch_premise_vectors, minibatch_hypothesis_vectors, minibatch_premise_vectors_bi, minibatch_hypothesis_vectors_bi,minibatch_premise_vectors_tri, minibatch_hypothesis_vectors_tri, minibatch_labels, minibatch_genres = self.get_minibatch(
